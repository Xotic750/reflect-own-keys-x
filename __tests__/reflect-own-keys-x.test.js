import $reflectOwnKeys, {implementation} from '../src/reflect-own-keys-x';

const hasSymbols = typeof Symbol === 'function' && typeof Symbol('') === 'symbol';
const ifSymbolsIt = hasSymbols ? it : xit;

[implementation, $reflectOwnKeys].forEach((reflectOwnKeys, testNum) => {
  describe(`reflectOwnKeys ${testNum}`, function() {
